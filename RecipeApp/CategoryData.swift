...
let categoriesData: [MealsCategory] = [
    ...
    MealsCategory(img: UIImage(named: "category_img_2.png")!, title: "Other"),
    MealsCategory(img: UIImage(named: "category_img_3.png")!, title: "Vegan"),
    MealsCategory(img: UIImage(named: "category_img_4.png")!, title: "Soups"),
    MealsCategory(img: UIImage(named: "category_img_5.png")!, title: "Mixed"),
